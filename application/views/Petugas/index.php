                                ...
                                <tbody>
                                    ...
                                    <tr id="row<?=$value->kd_petugas?>">
                                        ...
                                        <td>
                                            ...
                                            <a data-id="row<?=$value->kd_petugas?>" href="<?= base_url('Petugas/delete/'.$value->kd_petugas)?>" class="delete-btn btn btn-sm btn-danger notika-btn-success waves-effect">Delete</a>
